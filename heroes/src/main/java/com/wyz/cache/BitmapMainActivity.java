...
import com.wyz.cache.utils.ImageLoader;
import com.wyz.cache.utils.MyUtils;
...
public class BitmapMainActivity extends Activity implements AbsListView.OnScrollListener {
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (mIsGridViewIdle && mCanGetBitmapFromNetWork) {
                ...
                //通过bindBitMap将图片加载交给ImageLoader处理，加载图片后会把图片自动设置给ImageView
